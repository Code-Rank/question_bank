        ...
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <hr />
                    <form action="{{url('admin/chapter/update_chapter_insert/'.$data->id)}}" method="post">
                        @csrf

                        <div class="form-group">
                            <label for="cc-payment" class="control-label mb-1"> Chapter No</label>
                            <input id="color" name="chapter_no" type="text" class="form-control" value="{{$data->chapter_no}}" />
                            @error('chapter_no')
                        ...
                        <div class="form-group">
                            ...
                            <input id="color" name="chapter_name" type="text" class="form-control" value="{{$data->chapter_name}}"  />
                            @error('chapter_name')
                            <div class="alert alert-danger">
                                {{$message}}
                            </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <select name="book_select" id="select" class="form-control">
                                    ...
                                    @if($book_list->book_id == $data->book_id)
                                    <option value="{{$book_list->book_id}}" selected >{{$book_list->book_name}}</option>
                                    @else
